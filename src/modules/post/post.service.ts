import { CommentStatus, Post, PostStatus, UserRole } from "../../../generated/prisma/client";
...
/*
/1. user-nijer post delete
/2. admin- sobar post delete
*/
...
const getStats = async () => {
    return await prisma.$transaction(async (tx) => {
        const [totalPosts, publicPosts, draftPosts, archivedPosts, totalComments, approvedComments, rejectedComments,
            totalUsers, adminCount, userCount, totalViews
        ] = await Promise.all([
            await tx.post.count(),
